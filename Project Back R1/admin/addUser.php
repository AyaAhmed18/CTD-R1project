...
//insert date of new user
  try{
    $sql = 'INSERT INTO `users`( `name`, `username`, `email`, `active`, `password`) VALUES (?,?,?,?,?)';
    $stmt=$conn->prepare($sql);
    $stmt ->execute([$name,$userName,$email,$state,$hash]);
    //header("Location: login.php");
    //die();
    //echo "Data added successfully";
  }catch(PDOException $e){
    echo "failed to insert user date:" .$e->getMessage();
  }
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" action="<?php echo $_SERVER["PHP_SELF"] ?> " method="POST"  data-parsley-validate class="form-horizontal form-label-left">
