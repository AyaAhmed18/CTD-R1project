...
if(isset($_GET["id"])){
  ...
  //values of meeting data from database
    $date = $result["date"];
    $title = $result["title"];
  ...
  echo "failed to show meeting data:" .$e->getMessage();
}
}
}
            ...
            <div class="col-lg-12">
              <div class="meeting-single-item">
                <div class="thumb">
                  ...
                  <a href="meeting-details.php"><img src="admin/images/<?php echo $image?>" alt=""></a>
                </div>
                <div class="down-content">
                  <a href="meeting-details.php"><h4><?php echo $title ?></h4></a>
                  <p>Recreio dos Bandeirantes, Rio de Janeiro - RJ, 22795-008, <?php echo $location ?></p>
                  <p class="description">
										<?php echo $content ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4">
                      <div class="location">
                        ...
                        <br>Rio de Janeiro - RJ, 22795-008, <?php echo $location ?></p>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="book now">
